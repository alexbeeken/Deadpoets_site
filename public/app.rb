...
DB = PG::Connection.open(:dbname => 'dc4clh7i0hvanm', :host => 'ec2-54-225-101-64.compute-1.amazonaws.com', :port => '5432', :password => 'sD1-1diPFYKeuqs3mU_FkJ1tjW', :user => 'ndpcmhkggeejyz')
